...
const PJBoldPortfolio = () => {
  ...
  const beforeImage = "../lovable-uploads/5457ce9a-bdc8-4994-9e9f-80ba6bda34c6.png";
  const afterImage = "../lovable-uploads/6a11b21e-8290-4f79-8859-e72052619447.png";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Achieving 7x Sales Increase with Strategic Google Ads Management - A Case Study in Overcoming Challenges and Maximizing ROAS
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-16">
            <Card className="text-center p-6 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
              ...
              <h3 className="text-3xl font-bold text-primary mb-2">7x</h3>
            ...
            <Card className="text-center p-6 bg-gradient-to-br from-emerald-500/5 to-emerald-500/10 border-emerald-500/20">
              ...
              <h3 className="text-3xl font-bold text-emerald-600 mb-2">694%</h3>
