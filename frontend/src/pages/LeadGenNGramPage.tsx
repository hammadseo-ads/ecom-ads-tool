...
const LeadGenNGramInner = ({ selectedAccountId, selectedAccountName }: InnerProps) => {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-2xl flex items-center gap-2">N-Gram Analysis <span className="text-emerald-800 text-[11px] font-bold uppercase tracking-wide bg-emerald-50 px-1.5 py-0.5 rounded">Lead Gen</span></CardTitle>
          </div>
          <CardDescription>
...
const LeadGenNGramPage = () => (
  <DashboardShell>
    {({ selectedAccountId, selectedAccountName }) => (
      <LeadGenNGramInner selectedAccountId={selectedAccountId} selectedAccountName={selectedAccountName} />
    )}
  </DashboardShell>
);

export default LeadGenNGramPage;
