// Heat Map (Hour × Day) Analysis page.
//
...
const METRICS = [
  ...
  { key: "roas", label: "ROAS", icon: TrendingUp, format: (n: number) => n.toFixed(2) },
...
const HeatMapInner = ({ selectedAccountId, selectedAccountName }: InnerProps) => {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-2xl">Hour × Day Heat Map</CardTitle>
          </div>
          <CardDescription>
